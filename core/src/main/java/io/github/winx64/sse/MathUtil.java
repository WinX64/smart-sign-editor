...
public final class MathUtil {
     ...
     */
    private static final Map<BlockFace, Vector> SIGN_NORMAL_VECTORS = Collections
            .unmodifiableMap(Stream.of(BlockFace.values()).filter(face -> face.getModX() != 0 || face.getModZ() != 0)
                    .collect(toMap(face -> face, face -> {
     ...
     * @param planeNormal   A normal vector of the plane
     * @return The t value
     */
     ...
     * @param planePoint   The sign's plane central point
     ...
     *
     * @param linePoint   The given point
     * @param planePoint  A point of the plane
     * @param planeNormal The plane's normal vector
     * @return Whether or not the point of in front of the plane
     */
